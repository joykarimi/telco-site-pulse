...
export const ROLE_PERMISSIONS: Record<UserRole, string[]> = {
  [ROLES.ADMIN]: [
    ...
    PERMISSIONS.MOVEMENT_DELETE, // Admin can delete movement requests
  ...
  [ROLES.OPERATIONS_MANAGER]: [
    ...
    PERMISSIONS.MOVEMENT_READ,
    PERMISSIONS.MOVEMENT_UPDATE,
    PERMISSIONS.MOVEMENT_DELETE, // Operations Manager can delete movement requests
    PERMISSIONS.USER_MANAGEMENT_READ,
  ],
  [ROLES.MAINTENANCE_MANAGER]: [
    ...
    PERMISSIONS.MOVEMENT_APPROVE, 
    PERMISSIONS.MOVEMENT_READ,
    PERMISSIONS.MOVEMENT_DELETE, // Maintenance Manager can delete movement requests
    PERMISSIONS.USER_MANAGEMENT_READ,
  ],
  [ROLES.USER]: [
    PERMISSIONS.SITE_READ,
